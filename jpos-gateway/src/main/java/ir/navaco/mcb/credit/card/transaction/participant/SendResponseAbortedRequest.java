...
public class SendResponseAbortedRequest implements AbortParticipant {
    ...
    public int prepareForAbort(long id, Serializable serializable) {
        ...
        try {
            isoResponseMsg.setResponseMTI();
//            Message1110 message1110 = (Message1110) UnpackISOMessage.parseISOMessage(isoResponseMsg);
//            IResponseMessageFinAuthRev respMsg = (IResponseMessageFinAuthRev) message1110;
